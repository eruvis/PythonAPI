...
class TestUserAuth:
    def test_user_auth(self):
        ...
        auth_sid = response1.cookies.get("auth_id")
        ...
        assert user_id_from_auth_method == user_id_from_check_method, "User id from auth method is not equals to user id from check method"
